...
function renderBall(){
  board.ball.move()
  $('#ball').css('top', board.ball.y + 'px')
  $('#ball').css('left', board.ball.x + 'px')
 }

 function renderPaddle(){
  $('#paddle1').css('top', board.paddle1.y + 'px')
  $('#paddle1').css('left', board.paddle1.x + 'px')

  $('#paddle2').css('top', board.paddle2.y + 'px')
  $('#paddle2').css('left', board.paddle2.x + 'px')
 }
